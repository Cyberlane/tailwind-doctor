...
func TestInspectContrast(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "order-sensitive stacked variants", classes: "hover:dark:text-gray dark:hover:bg-light", unknownReason: unknownMissingBackground},
		{name: "matching stacked variants", classes: "hover:dark:text-gray hover:dark:bg-light", findings: 1, resolved: 1},
